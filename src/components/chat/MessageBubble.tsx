        ...
        {[0, 1, 2].map((i) => (
          <div
            ...
            style={{
              ...
              height: 6,
              borderRadius: "50%",
              background: "#43A047", // QiDesk Green for active loading
      ...
      >
        {editing ? (
          <div style={{ maxWidth: "72%", width: "100%" }}>
            <textarea
              ...
              style={{
                ...
                border: "2px solid #0B2463", // Deep Blue border
                background: "#ffffff",
                color: "#0f172a",
                fontFamily: "inherit",
                resize: "none",
                outline: "none",
                minHeight: 60,
                boxShadow: "0 4px 12px rgba(11, 36, 99, 0.05)"
              }}
            />
            <div
              style={{
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: "#43A047", // QiDesk Green
                  color: "#ffffff",
                  fontSize: 12,
                  fontWeight: 600,
                  cursor: "pointer",
          ...
          <div
            style={{
              maxWidth: "70%",
              background: "#0B2463", // QiDesk Deep Blue
              color: "#ffffff",
              borderRadius: "18px 18px 4px 18px",
              padding: "12px 18px",
              fontSize: 14,
              lineHeight: 1.5,
              boxShadow: "0 4px 12px rgba(11, 36, 99, 0.15)"
            }}
          >
            {msg.content}
          </div>
        ...
        {!editing && hovered && (
          <div style={{ display: "flex", gap: 4, marginTop: 6, animation: "fadeInUp 0.2s ease" }}>
            <ActionBtn
            ...
            {onDelete && (
              <ActionBtn title="Delete this message" onClick={onDelete}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18" /><path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2" /></svg>
                Delete
              </ActionBtn>
            )}
          </div>
      ...
      >
        <div
          style={{
            ...
            flexShrink: 0,
            boxShadow: "0 2px 8px rgba(11, 36, 99, 0.15)"
          }}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="12" rx="10" ry="10" /><path d="M12 6v6l4 2" /></svg>
        </div>
        <LoadingIndicator />
      </div>
    );
      ...
      >
        <div
          style={{
            width: 30,
            height: 30,
            background: "#0B2463", // Deep Blue Avatar
            borderRadius: "50%",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {hovered && (
            <div style={{ display: "flex", gap: 4, marginTop: 8, animation: "fadeInUp 0.2s ease" }}>
